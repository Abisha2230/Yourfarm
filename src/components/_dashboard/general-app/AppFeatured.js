...
function CarouselItem({ item, isActive ,dName}) {
...
export default function AppFeatured( { displayName }) {
    ...
    <Card>
      <Slider ref={carouselRef} {...settings}>
        {MOCK_APPS.map((app, index) => (
          <CarouselItem key={app.id} item={app} isActive={index === currentIndex} dName={displayName} />
        ))}
      </Slider>
